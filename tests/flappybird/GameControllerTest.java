...
public class GameControllerTest {
    ...
    /**
     * @test Verifica que cuando el juego no está pausado, se actualiza el modelo y se repinta la
     * vista.
     */
    @Test
    ...
    /**
     * @test Verifica que si el juego está pausado, no se actualiza el modelo pero sí se repinta la
     * vista.
     */
    @Test
    ...
    void testKeyPressedUpTriggersJump() {
        ...
        try {
            ...
            assertEquals(
                1, stubModel.jumpCount, "Al presionar VK_UP, keyPressed debe llamar birdJump()");
